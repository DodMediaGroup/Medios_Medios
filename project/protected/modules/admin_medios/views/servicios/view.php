<div class="profile-banner">
	<div class="my-header-blur" style="background-image: url(<?php echo Yii::app()->request->baseUrl; ?>/images/servicios/<?php echo $model->imagen; ?>);"></div>
	<div class="col-sm-3 avatar-container">
		<div class="img-circle profile-avatar" style="background-image: url(<?php echo Yii::app()->request->baseUrl; ?>/images/servicios/250x250/<?php echo $model->imagen; ?>); background-size: cover; height: 200px;"></div>
	</div>
</div>

			...
			<div class="widget">
				...
				<div class="widget-content padding">
					...
					<div class="form-group">
						...
						<div class="imag-before-upload" style="background-image: url(<?php echo Yii::app()->request->baseUrl; ?>/images/servicios/default.jpg);">
							<?php if(!$model->isNewRecord){ ?>
								<div class="img" style="background-image: url(<?php echo Yii::app()->request->baseUrl; ?>/images/servicios/250x250/<?php echo $model->imagen; ?>)"></div>
							<?php } ?>
						</div>

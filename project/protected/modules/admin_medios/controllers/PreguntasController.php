...
class PreguntasController extends Controller
{
    ...
    public function actionAdmin()
    {
        ...
        $preguntas = Preguntas::model()->findAll(array('condition'=>'t.estado != 2', 'order'=>'t.id_preguntas DESC'));
     ...
     */
    public function actionDelete_pregunta($id)
    {
        $entry = $this->loadModel($id);
    ...
    {
        $model=Preguntas::model()->findByAttributes(array('id_preguntas'=>$id), array('condition'=>'t.estado != 2'));
        if($model===null)
            throw new CHttpException(404,'The requested page does not exist.');
        return $model;
    }

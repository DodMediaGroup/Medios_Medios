...
class Controller extends CController
{
	...
	public $pageTitle = 'M:S:M';
	public $pageDescription = 'Medios Sobre Medios E.U. Es una empresa con permanencia en Boyacá, con tradición, solidez, responsabilidad y cumplimiento. Nuestros servicios se extienden a la Radio, Televisión, Periódicos, Revistas, paraderos de buses urbanos, vallas y demás formas impresas. Tenemos vínculo comercial con medios como El Tiempo, Boyacá 7 Días, El Lunes, Enterese, Extra, Caracol, RCN, y más de 30 emisoras regionales.';
